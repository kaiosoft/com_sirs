...
<form action="index.php" method="post" name="adminForm">
  <table width="100%" border="0" cellpadding="4" cellspacing="1" class="admintable">
    <!-- <tr>
	 ...
	 <tr>
      <td width="18%" align="right" class="key">Hari * : </td>
      <td width="82%"><?php echo $lists['hari']; ?></td>
    </tr>
	-->
	 <tr>
      <td width="18%" align="right" class="key">Jam Mulai * : </td>
      <td width="82%"><?php echo $lists['sjam']; ?></td>
    </tr>
	 <tr>
      <td width="18%" align="right" class="key">Jam Selesai * : </td>
...
<input type="hidden" id="dokter_id" name="dokter_id" value="<?php echo $this->data['jadwal'][0]->dokter_id.JRequest::getVar('dokter_id'); ?>" />
<input type="hidden" id="hari" name="hari" value="<?php echo $this->data['jadwal'][0]->hari.JRequest::getVar('hari'); ?>" />
<input type="hidden" id="id" name="id" value="<?php echo $this->data['jadwal'][0]->id; ?>" />
